...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        LogInfo(msg="Starting Robot with Nav2 and SLAM..."),
        ...
        Node(
            ...
            condition=IncludeLaunchDescription.condition_if(slam)
        ),
        ...
        LogInfo(msg="Robot with Nav2 and SLAM launched successfully!"),
    ])
